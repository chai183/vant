...
<template>
  ...
  <demo-block :title="t('title2')">
    <van-slider v-model="rangeValue" type="range" :min="0" :max="100" @change="onChange" />
  </demo-block>

  <demo-block :title="t('title3')">
    <van-slider v-model="nodeRangeValue" type="node-range" :min="200" :max="600" :step="200" @change="onChange" />
  </demo-block>

  <demo-block :title="t('title4')">
    <van-slider v-model="amountRange" type="range" show-inputs :min="AMOUNT_MIN" :max="AMOUNT_MAX"
      :min-placeholder="t('minPlaceholder')" :max-placeholder="t('maxPlaceholder')" />
  </demo-block>

  <demo-block :title="t('title5')">
    <van-slider v-model="singleAmount" type="single" show-value :min="AMOUNT_MIN" :max="AMOUNT_MAX"
  ...
  <demo-block :title="t('customStyle')">
    <van-slider v-model="value6" type="single" active-color="#ff6b00" @change="onChange" />
  </demo-block>
  ...
  <demo-block :title="t('vertical')">
    <div class="demo-slider-vertical">
      ...
      <van-slider v-model="nodeRangeValue" type="node-range" vertical :min="200" :max="1000" :step="200"
        @change="onChange" />
    </div>
  </demo-block>
</template>
