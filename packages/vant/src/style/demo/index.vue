...
const t = useTranslate({
  'zh-CN': {
    ...
    grayBlockText: '这是一段提示文字，常用于表单底部说明区域。',
  },
  'en-US': {
    hairline: 'Hairline',
    ellipsis: 'Text Ellipsis',
    grayBlock: 'Gray Block',
    animation: 'Animation',
    ...
    grayBlockText:
      'This is a hint text, commonly used in form bottom description areas.',
  },
});
...
<template>
  ...
  <demo-block card :title="t('grayBlock')">
    <div class="van-gray-block">{{ t('grayBlockText') }}</div>
  </demo-block>
