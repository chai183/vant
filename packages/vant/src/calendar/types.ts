...
export type CalendarThemeVars = {
  ...
  calendarPaddingHorizontal?: string;
  calendarMonthGap?: string;
  ...
  calendarToolbarHeight?: string;
  calendarActionPadding?: string;
  calendarActionFontSize?: string;
  calendarConfirmActionColor?: string;
  calendarCancelActionColor?: string;
  calendarToolbarTitleFontSize?: string;
  calendarToolbarTitleLineHeight?: string;
};
